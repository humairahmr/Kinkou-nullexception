...
| Eventbrite | Provides event information based on user’s current location | - Forces users to manually cross-reference dates to prevent schedule clashes. <br/>  - Fails to indicate event intensity, leaving users to gamble on whether they have the mental bandwidth for high-energy activities | 
