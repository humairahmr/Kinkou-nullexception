...
|:----------:|:------------|:----------|
| Quabble, Finch |Share similar concepts, allow users to customize their pets and focus on the user's mental health. Both take different approaches to mental wellness.  <br> Quabble - focus on guiding users toward calmness <br>  Finch - emphasizes on adding coping activities in the user’s schedule | Addressing only one side of the coin, users need guidance on staying calm and practical tools to schedule positive routines simultaneously. |
